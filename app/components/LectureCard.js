...
const LectureCard = ({ title, img, linkedin, description, name }) => {
  ...
  return (
    <div
      ...
      onClick={ handleClick }
      className="group relative rounded-lg p-4 bg-slate-800 backdrop-blur-lg shadow-3xl shadow-zinc-100 transform transition-all duration-500 ease-in-out hover:scale-105 hover:z-10 cursor-pointer h-full"
    >
