...
const PanelData = [
  ...
  },
  {
    ...
    date: "24th March, 2024",
    description:
      "CATChamps is a series of panel discussions organized by BITS Pilani. The event aims to provide students with valuable insights, strategies, and resources to help them prepare for CAT.",
    link: "",
    speakers: [
      {
        name: "Adit Kalbalia",
        imgSrc: "/img/panel/catchamps24/adit_kalbalia.jpg",
        linkedin: "",
        description: "99.99%ile",
      },
      {
        name: "Dhruv Jajoo",
        imgSrc: "/img/panel/catchamps24/dhruv_jajoo.jpg",
        linkedin: "",
        description: "99.91%ile",
      },
      {
        name: "Arun Kumar",
